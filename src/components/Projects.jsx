...
function Projects({ onClose }) {
   return (
      <Draggable handle=".folder__top__draggable" bounds={{ top: -200, left: -150, right: 500, bottom: 150 }}>
         <div className="folder projects">
            <div className="folder__top">
               <div className="folder__top__name">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height="20px" width="20px" fill="currentColor">
               ...
               <div className="folder__top__draggable">drag zone</div>
               <label className="folder__top__close" onClick={onClose}>
                  X
               </label>
            </div>
            ...
            <div className="folder__bottom">
               <div className="folder__bottom__file">
                  <a title="all projects" href="https://visheshchoudhary.in/" rel="noopener noreferrer" target="_blank">
                     <svg
                     ...
                     <div className="folder__bottom__txt">Xen.rs</div>
                  </a>
               ...
               <div className="folder__bottom__file">
                  <a
                     title="last project"
                     href="https://github.com/visheshc14/Prisonic-Fairytale"
                     ...
                     <div className="folder__bottom__txt">Prisonic-Fairytale.mix</div>
                  </a>
               </div>
               <div className="folder__bottom__file">
                  <a
                     title="last project"
                     href="https://github.com/visheshc14/Audio-Arca"
                     rel="noopener noreferrer"
                     target="_blank">
                     <svg
                        className="folder__bottom__image"
                     ...
                     <div className="folder__bottom__txt">Audio-Arca.go</div>
                  </a>
               </div>
               <div className="folder__bottom__file">
                  <a
                     title="last project"
                     href="https://github.com/visheshc14/Electric-Funeral"
                     rel="noopener noreferrer"
                     target="_blank">
                     <svg
                        className="folder__bottom__image"
                     ...
                     <div className="folder__bottom__txt">Electric-Funeral.sh</div>
                  </a>
               </div>
               <div className="folder__bottom__file">
                  <a
                     title="last project"
                     href="https://github.com/visheshc14/Neural-Network-Art"
                     rel="noopener noreferrer"
                     target="_blank">
                     <svg
                        className="folder__bottom__image"
                     ...
                     <div className="folder__bottom__txt">Neural-Network-Art.clj</div>
                  </a>
               </div>
            </div>
         </div>
